...
const adaptee_1 = __importDefault(require("./src/adapter/adaptee"));
const adapter_1 = __importDefault(require("./src/adapter/adapter"));
const printer_1 = __importDefault(require("./src/adapter/printer"));
...
// console.log(resultB);
const adapter = new adapter_1.default(new adaptee_1.default('latin printer : print english words'));
const englishPrinter = new printer_1.default(adapter);
